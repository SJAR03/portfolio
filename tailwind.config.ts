  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "text-accent-blue": "hsl(var(--text-accent-blue))",
        "text-accent-lavander": "hsl(var(--text-accent-lavander))",
        "text-accent-columbia": "hsl(var(--text-accent-columbia))",
        "text-accent-black": "hsl(var(--text-accent-black))",
        primary: {
